...
// VIKA_Diplom.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CVIKADiplomApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CVIKADiplomApp

CVIKADiplomApp::CVIKADiplomApp()
{
...
// Единственный объект CVIKADiplomApp

CVIKADiplomApp theApp;


// Инициализация CVIKADiplomApp

BOOL CVIKADiplomApp::InitInstance()
{
